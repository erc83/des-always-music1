...
}).command('editar', 'actualiza el estudiante',createAndEditArgs,(args) =>{
    const queryEdit = {
...
}).command('consultarut', 'consulta 1 estudiante por rut toda su informacion', {rut:createAndEditArgs.rut}, (args)=>{     
...
}).command('eliminar', 'eliminar 1 estudiante por rut', {rut:createAndEditArgs.rut} ,(args)=>{     
